      ...
      <article style={{minWidth:'27vw'}}>
        <header className="mb-1 px-2 flex justify-between items-center">
          <a href="#" className="flex">
            ...
            <span className="ml-2 font-semibold">lumi_candle_boutique</span>
          </a>
        ...
        <main className="grid grid-cols-1 gap-1">
          <img src={instafeed.name} alt="" className="min-h-full"/>
        ...
        <footer className="px-2">
          ...
          <p className="">
            <a href="#" className="mr-1 font-semibold">lumi_candle_boutique</a>i found this in my grandma's attic 💐
          </p>
