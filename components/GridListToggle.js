...
const GridListToggle = () => {
    ...
    <Row className="row" style={{fontSize:'16px'}}>
        ...
        <div className="list-group">
              ...
              <Row>
                ...
                <Col md={4} className="media col-md-3">
                    <figure className="pull-left">
                        <img style={{height:'50px',width:'50px'}} className="media-object img-rounded img-responsive"  src="http://placehold.it/350x250" alt="placehold.it/50x50" />
                    </figure>
                </Col>
                <Col md={2}></Col>
                <Col md={6} className="col-md-6" style={{textDecoration:'none'}} >
          ...
          />
          &nbsp;<span><button>220 reviews</button></span>
                </Col>
