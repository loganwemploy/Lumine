...
const Coupon = () => {
    return (
        <>
          <Row className="row coupon-all" style={{display: 'flex', justifyContent:'center'}}>
        <Col md={6} className="col-md-6 col-md-offset-3">
            <div className="panel panel-default coupon">
              ...
              <div className="panel-body">
                <img style={{height:"300px"}} src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fcanpromos.ca%2Fwp-content%2Fuploads%2F2020%2F07%2FPC-PPEKIT-EMP.jpg&f=1&nofb=1" className="coupon-img img-rounded"/>
                ...
                <Col md={3} className="col-md-3">
                    <div className="offer">
                        ...
                        <span className="usd"><sup>$</sup></span>
                        <span className="number">0</span>
                        <span className="cents"><sup>00</sup></span>
                    </div>
                </Col>
                <Col md={12} className="col-md-12">
                    <p className="disclosure">Using Genuine Oil Filter and 
              ...
              <div className="panel-footer">
                <div className="coupon-code">
                    ...
                    <span className="print">
                        <a href="#" className="btn btn-link"><i className="fa fa-lg fa-print"></i> Print Coupon</a>
                    </span>
                </div>
