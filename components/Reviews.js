                ...
                <Col md={2} sm={2} className="col-md-2 col-sm-2 hidden-xs">
                  <figure className="thumbnail">
                    <img
                      ...
                      style={{ borderRadius: "1em", padding: "7px" }}
                      src="https://placehold.it/160x160.jpg"
                    />
                    ...
                    <div className="panel-body" style={{ maxWidth: "88%" }}>
                      <header className="text-left">
                        <div className="comment-user">
                          ...
                          <b>
                            This Hoodie was the highest of quality, will buy
                            again.
                          </b>
                        </div>
                        <time
                          className="comment-date"
                          datetime="12-1-2021 01:05"
                        >
                          <i className="fa fa-clock-o"></i>Jan 12, 2020
                        </time>
                      </header>
                      ...
                      <p className="text-right">
                        <a href="#" className="btn btn-primary btn-sm">
                          <i className="fa fa-reply"></i> leave a review
                        </a>
                      </p>
                    </div>
                  </div>
