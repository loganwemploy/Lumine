...
const BubbleCategories = () => {
    ...
    return (
      ...
      <div className="FeedTitleContainer">
          <br/>
        <h2 className="FeedSubtitle">Explore our Candle Collections</h2>
        <br/>
        <span className="FeedDescription">Candles inspired by cool trips and surprising stories</span>
    ...
    <br/>
    <br/>
<div style={{position:'relative',display:'flex',justifyContent:'flex-start',maxWidth:'100vw'}}>
