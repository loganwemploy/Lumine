    ...
    <div className="grid menu">
      ...
      <div className="column-xs-4 column-md-6">
        ...
        <ul>
          ...
          <li className="nav-item"><a href="#">Cart (0)</a></li>
        </ul>
      </div>
    </div>
  </div>
...
<footer>
  <div className="grid">
    <div className="column-xs-12">
      <p className="copyright">&copy; Copyright 2018 <a href="https://katherinekato.com" title="Katherine Kato"  target="_blank">Katherine Kato</a></p>
    </div>
  </div>
</footer>
        </StyledPdp>
